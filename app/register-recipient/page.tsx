...
export default function RegisterRecipientPage() {
  ...
  const { registerRecipient, loading: storageLoading } = useDualStorage()
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Register recipient using dual storage
      ...
      if (recipient) {
        toast({
          ...
          description: "Your recipient registration has been saved and you'll be notified of potential matches",
        })
                  ...
                  <div className="space-y-4">
                    <Alert className="border-blue-200 bg-blue-50">
                      ...
                      <AlertDescription className="text-blue-800">
                        <strong>Priority Matching System:</strong>
                        <br />• Your urgency level: {URGENCY_LEVELS.find(l => l.value === formData.urgency)?.label || 'Not selected'}
                        <br />• Higher urgency = higher priority in matching
                        <br />• Age and waiting time also factor into priority
                        <br />• You'll be notified immediately when matches are found
                      </AlertDescription>
                    </Alert>
              ...
              <div className="flex justify-between pt-4">
                ...
                {step < 3 ? (
                  ...
                  <Button 
                    ...
                    disabled={loading || storageLoading || !formData.consentGiven || !formData.kycVerified}
